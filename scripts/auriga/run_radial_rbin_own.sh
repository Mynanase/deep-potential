#!/usr/bin/env bash
# Radial r-bins, each model judged against its own population truth.
set -eo pipefail
...
echo '=== RADIAL RBIN OWN PREFLIGHT ==='
...
"$PY" -u scripts/auriga/df_radial_rbin_own.py
echo '=== RADIAL RBIN OWN DONE ==='
