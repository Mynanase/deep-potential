#!/usr/bin/env bash
# w1024clean vs clean-population truth: the three comparison figures.
set -eo pipefail
...
echo '=== CLEAN-TRUTH COMPARISON PREFLIGHT ==='
...
"$PY" -u scripts/auriga/df_clean_truth_comparison.py
echo '=== CLEAN-TRUTH COMPARISON DONE ==='
