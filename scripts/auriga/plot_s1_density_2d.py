#!/usr/bin/env python
"""Log-color 2D density maps, truth comparison, and residuals.
...
MODEL_TEXT = {"base": "base (seed-0)", "S1": "S1 (stratified)",
              "gridprior": "S1 + grid prior"}
COLS = ("truth", "base", "S1", "gridprior")
...
def main():
    ...
    for l in MODELS:
        color = {"base": "blue", "S1": "red", "gridprior": "purple"}[l]
    ...
    np.savez(args.output_dir / "gridprior_density_2d.npz",
    ...
    for p in ofs.save(fig, str(args.output_dir / "gridprior-density-2d")):
        print("saved", p)
