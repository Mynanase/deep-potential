...
Models: base, lambda10, innerA, gridprior - the route-relevant set of the
lambda round (node 63cad24d lineage). No retraining. Figures: (a) M_shell
log-log truth vs models;
...
MODELS = ("base", "lambda10", "innerA", "gridprior")
