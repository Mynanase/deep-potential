#!/usr/bin/env bash
# Radial r-bins, per-model own truth, unnormalized mass histograms.
set -eo pipefail
...
echo '=== RADIAL RBIN MASS PREFLIGHT ==='
...
"$PY" -u scripts/auriga/df_radial_rbin_mass.py
echo '=== RADIAL RBIN MASS DONE ==='
