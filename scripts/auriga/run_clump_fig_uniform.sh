#!/usr/bin/env bash
# fig_clump_conditional_vT on one uniform spatial region.
set -eo pipefail
...
echo '=== CLUMP FIG UNIFORM PREFLIGHT ==='
...
"$PY" -u scripts/auriga/df_clump_fig_uniform.py
echo '=== CLUMP FIG UNIFORM DONE ==='
