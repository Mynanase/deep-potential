"""Operational DF training workflow."""
...
def run_df_training(
    ...
    *,
    ...
    save_normalizer_npz(normalizer, run_dir / "normalizer.npz")
    ...
    print(f"[train_df] parameter_count={parameter_count}")
    ...
    if lr_schedule_name == "plateau":
        ...
        base_opt = build_optimizer(optimizer_name, warmup_lr_schedule)
