"""Repository-specific diagnostic figure builders.
...
def plot_phase_space_grid(
    eta: np.ndarray,
    *,
    eta_sample: np.ndarray | None = None,
...
def plot_density_profile(
    ...
    *,
    phi_learned_shift: np.ndarray | None = None,
    phi_true: np.ndarray | None = None,
    ar_learned: np.ndarray | None = None,
    ar_true: np.ndarray | None = None,
    fig_dir: str | Path | None = None,
    fig_fmt: Iterable[str] = ("png",),
    dpi: int = 150,
):
...
def plot_potential_rz_by_phi(
    ...
    *,
    ...
    truth_count: np.ndarray | None = None,
...
def plot_auriga_df_ensemble(
    ...
    *,
    ...
    n_models, n_pts, _dim = scores.shape
    ...
    if run_dirs:
        from experiments.plotting.training_curves import plot_df_training_ensemble
